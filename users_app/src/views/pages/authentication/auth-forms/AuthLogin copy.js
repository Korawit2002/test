    ...
    <>
      <Grid container direction="column" justifyContent="center" spacing={2}>
        <Grid item xs={12} container>
          <Box sx={{ mb: 4 }}>
            <Typography variant="subtitle1">Unlock exclusive TEF content! Don't miss out on updates—</Typography>
            <Typography variant="subtitle1">
              <Link href="/register/vet/" color="primary">
                sign up
              </Link>{' '}
              for your TEF account now or you'll regret missing the latest news
            </Typography>
          </Box>
        </Grid>
      </Grid>
        ...
        onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
          ...
          try {
            ...
            if (jsonData && jsonData.message === "Login successful") {
              ...
              // อาจเก็บข้อมูลผู้ใช้ใน localStorage หรือ context ถ้าต้องการ
          ...
          <form noValidate onSubmit={handleSubmit} {...others}>
            <FormControl fullWidth sx={{ mb: 3 }}>
              <TextField
                ...
                label={
                  <>
                    Identification<RedAsterisk>*</RedAsterisk>
                  </>
                }
                placeholder="TEF ID/ Club ID/ Vet. ID"
                InputProps={{
