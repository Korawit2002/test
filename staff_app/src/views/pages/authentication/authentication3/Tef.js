...
const Tef = () => {
  ...
  const handleFileChangeCard = (event) => {
    ...
    if (file) {
      ...
      console.log("Selected card file:", file);
    }
  };
              ...
              <Grid item xs={12} mt={1}>
                ...
                <Typography style={{ width: '100%', height: '100%' }}>
                  ...
                  <TextField
                      ...
                      InputProps={{
                        startAdornment: (
                          <InputAdornment position="start" style={{ color: 'rgba(0, 0, 0, 0.38)' }}>
            ...
            <Grid item xs={12} sm={4}>
              <FormControl fullWidth variant="outlined">
                ...
                <LocalizationProvider dateAdapter={AdapterDateFns}>
                  <DatePicker
                    disableFuture
                    name="ParentfirstdateBirth"
                    value={formData.ParentfirstdateBirth}
                    onChange={(newValue) => handleDateChange('ParentfirstdateBirth', newValue)}
                    renderInput={(params) => (
                      <TextField
                        {...params}
                        fullWidth
           ...
           <Grid item xs={12} sm={4}>
            ...
            <Grid item xs={12} sm={4}>
                  <FormControl fullWidth variant="outlined">
                    ...
                    <Select
                      labelId="parent-subdistrict-label"
                      id="Parentsubdistrict"
                      name="Parentsubdistrict"
                      value={formData.Parentsubdistrict}
                      onChange={handleChange}
            ...
            <FormControl fullWidth variant="outlined">
              ...
              <LocalizationProvider dateAdapter={AdapterDateFns}>
                <DatePicker
                  name="idCardExpiration"
                  value={formData.idCardExpiration}
                  onChange={(newValue) => handleDateChange('idCardExpiration', newValue)}
                  renderInput={(params) => (
                    <TextField
                      {...params}
                      fullWidth
            ...
            <Grid item xs={12} sm={12} mt={6}>
              ...
              label={
                <Typography variant="body2">
                  ...
                  <span style={{color: 'primary', cursor: 'pointer'}}>click here</span>. TEF will do spot checks to verify the details declared are correct.
                  <br />
                  ฉันยอมรับตามข้อกำหนดและเงื่อนไขสมาชิก TEF ดูรายละเอียดเพิ่มเติม<span style={{color: 'primary', cursor: 'pointer'}}>คลิกที่นี่</span>
                  <br />
            ...
            />
              ...
              <Grid item xs={12} sx={{ display: 'flex', justifyContent: 'flex-end', mt: 3 }}>
                    <Button 
                        variant="outlined" 
                        sx={{ mr: 2 }} 
                        onClick={handleBackToHome}  // เพิ่ม onClick event
                      >
